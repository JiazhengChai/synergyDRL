...
class HumanoidEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self,
        ...
        self.joint_list=['abdomen_z','abdomen_y','abdomen_x','right_hip_x','right_hip_z','right_hip_y','right_knee','left_hip_x','left_hip_z',
         'left_hip_y','left_knee','right_shoulder1','right_shoulder2','right_elbow','left_shoulder1','left_shoulder2','left_elbow']
    ...
    def step(self, action):
        ...
        #states_speed=self.sim.data.qvel.flat.copy()
        states_angle=[]
